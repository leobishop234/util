...
func Migration(conf MigrationConfig, devDB DBConfig, schema embed.FS) Option {
	return func(o *dbOptions) {
		o.migration = &migrationOpts{conf: conf, devDB: devDB, schema: schema}
	}
}
...
func InitDB(ctx context.Context, conf DBConfig, opts ...Option) (*DB, error) {
	...
	if o.migration != nil && o.migration.conf.MigrationsEnabled {
		...
		if err := applySchema(ctx, conf, o.migration.devDB, schDir, o.migration.conf.atlasBin()); err != nil {
			return nil, err
		}
	}
