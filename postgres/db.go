...
func Migration(conf MigrationConfig, db DBConfig, schema embed.FS) Option {
...
func InitDB(ctx context.Context, conf DBConfig, opts ...Option) (*DB, error) {
	...
	if o.migration != nil && o.migration.conf.MigrationsEnabled {
		...
		if err := applySchema(ctx, conf, o.migration.db, schDir, o.migration.conf.atlasBin()); err != nil {
			return nil, err
		}
	}
